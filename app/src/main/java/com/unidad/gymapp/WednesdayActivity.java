...
public class WednesdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Toolbar
        Toolbar toolbar = findViewById(R.id.toolbarwednesday);
        ...
        // SharedPreferences
        prefs = getSharedPreferences("WednesdayPrefs", MODE_PRIVATE);
        ...
        progressPrefs.edit().putBoolean("Miercoles_completado", true).apply();
        ...
        btnBackHome.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(WednesdayActivity.this, HomeActivity.class);
        ...
        btn.setOnClickListener(v -> {
            camaraHelper = new CamaraVideoHelper(this, new CamaraVideoHelper.CameraCallback() {
                ...
                public void onPermissionDenied() {
                    Toast.makeText(WednesdayActivity.this, "Permiso de cámara denegado", Toast.LENGTH_SHORT).show();
                }
            }, videoLauncher);
    ...
    // Rutina por defecto del Miercoles
    private String getDefaultWarmup() {
        return "∙ Remo ergometro 3min \n";
    }
    ...
    private String getDefaultLegs() {
        return "Encogimientos con barra\n4×8–10 · Desc 90s";
    }
    private String getDefaultNutrition() {
        return "• Económica: Porotos + arroz + huevo duro\n" +
                "• Proteína: Carne Molida + yogurt natural + papas fresca\n" +
                "• Vegetariana: Porotos negros + palta + verduras";
    }
